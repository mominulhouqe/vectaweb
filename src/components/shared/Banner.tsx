...
const Banner = () => {
  ...
  const totalSlides = 3; // Update this as per the number of slides
        ...
        >
          ...
          <div className="w-full h-screen flex-shrink-0 relative">
            ...
            <div
              ...
              className="absolute top-1/4 left-1/2 transform -translate-x-1/2 w-full md:max-w-2xl p-6 rounded-lg text-center md:text-left font-light"
            >
              ...
              <div className="my-4 flex gap-1 items-center">
                ...
                <a href="https://x.com/vectaweb" target="_blank" className="">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-8 h-8"
                    viewBox="0 0 512 512"
                ...
                <a
                  href="https://www.youtube.com/@vectaweb"
                  target="_blank"
                  className="fill-red-600"
                >
                  <svg
          ...
          <div className="w-full h-screen flex-shrink-0 relative">
            ...
            >
              ...
              <a
                href="#contact"
                className="inline-block px-6 py-3 bg-green-500 text-white rounded-lg shadow-lg hover:bg-green-600 transition duration-300"
              >
                Get in Touch
              </a>
            </div>
