  ...
  return (
    <footer>
      <div className="bg-blue-950 text-white">
        <div
          className="container mx-auto p-6 md:p-10 grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6"
        >
          <div>
            <Image
              src={brandLogo}
          ...
          <div>
            ...
            <div className="relative mb-4">
              ...
              />
              <button
                className="absolute right-0 top-2 mr-2 p-1 px-4 rounded-3xl bg-blue-950 font-medium"
              >
                Subscribe
              </button>
            </div>
