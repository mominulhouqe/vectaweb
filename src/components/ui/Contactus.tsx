...
const Contactus = () => {
  return (
    <div>
      <section
        id="contact"
        className="relative max-w-7xl w-full mt-4 bg-gray-100 mx-auto "
      >
        <div className="w-full h-full  ">
          <div className="md:w-4/5 w-full mx-auto h-full flex flex-col md:flex-row justify-center items-center gap-4 py-4 md:py-12 px-6 md:px-0">
            <div className="max-w-1/2 w-full h-full mx-auto ">
              <button className="my-6 bg-teal-600 rounded-full hover:-translate-y-1 transform duration-300 font-medium py-2 px-8 cursor-pointer text-white">
                CONTACT US
              </button>
              ...
              <div className="grid grid-cols-2 md:gap-8 gap-5 my-6">
                <div className="flex gap-3 items-center">
                  <span className="bg-teal-600 rounded-full md:h-12 md:w-12 w-10  fill-white flex justify-center items-center">
                    <svg
            ...
            <div className="max-w-1/2 w-full mx-auto flex justify-cente items-center">
              <form className="h-full md:w-5/6 w-full rounded-xl bg-gray-200 px-4 py-4 mx-auto">
                <input
                  type="text"
                  name=""
                  id=""
